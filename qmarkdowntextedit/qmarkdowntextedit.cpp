...
QMarkdownTextEdit::QMarkdownTextEdit(QWidget *parent)
    ...
    int lcdFontId = QFontDatabase::addApplicationFont(":/web_res/Hiragino-Sans-GB-W3.ttf"); // 从source资源文件
...
//        qDebug()<<"m_fontList:" << m_fontList;
    ...
    this->setStyleSheet("QWidget {background-color:#FFFFFF; color:#000000; selection-background-color:#928374; }");
